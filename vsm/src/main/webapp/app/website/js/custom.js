...
$(document).ready(function() {   
    ...
    '<li><a href="css/slate.css" style="background:#3f444a">Slate</a></li>' +
    ...
    s.src = "app/website/js-plugin/jquery-cookie/jquery.cookie.js";
    $("body").append(s);  
...
function initialize(id) {
    "use strict";
    var image = 'website/images/icon-map.png';
